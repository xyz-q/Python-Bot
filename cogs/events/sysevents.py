...
class SystemCommands(commands.Cog):
    ...
    async def on_ready(self):
        ...
        print("\033[0;33mLogged in as {0}\033[0m".format(self.bot.user))
    ...
    async def on_error(self, event, *args, **kwargs):
        ...
        if channel:
            ...
            await self.bot.run(DISCORD_TOKEN)
    ...
    async def on_message(self, message):
        ...
        if message.content.startswith(self.bot.command_prefix):
            if not message.content.startswith(self.bot.command_prefix + "setup"):
                ...
                trusted_role = discord.utils.get(message.guild.roles, id=trusted_role_id)
        ...
        if not message.content.startswith(self.bot.command_prefix) and message.channel.name == allowed_channel_name:
            await message.delete()
