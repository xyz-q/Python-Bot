...
class list(commands.Cog):
    ...
    async def send_list(self, ctx, page, message=None):
        ...
        commands_page = self.commands_list[start_index:end_index]
        ...
        embed.set_footer(text=f"Page {page}/{(len(self.commands_list) - 1) // self.per_page + 1}")
        ...
        try:
            while True:
                ...
                if str(reaction.emoji) == '⬅️':
                    ...
                    page = min((len(self.commands_list) - 1) // self.per_page + 1, page + 1)
