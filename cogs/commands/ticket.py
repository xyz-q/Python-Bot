        ...
        async def on_submit(self, interaction: discord.Interaction):
            ...
            if interaction.guild:
                ...
                if ticket_channel is not None:
                    ...
                    embed.add_field(name="Submitted by", value=interaction.user.name,
                                    inline=False)  # Changed to use username
                    ...
                    await interaction.response.send_message(
                        "Ticket channel not found. Please contact an administrator.",
                        ephemeral=True)
            else:
                await interaction.response.send_message(
                    "Tickets have to be sent in a guild, silly! :3 /setup for more info", ephemeral=True)
    ...
    class TicketButtons(discord.ui.View):
        ...
        async def reject(self, interaction: discord.Interaction, button: discord.ui.Button):
            ...
            if trusted_role in interaction.user.roles:
                ...
                await interaction.response.send_message("You do not have permission to reject this ticket.",
                                                        ephemeral=True)
